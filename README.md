...
If Chrome loads the extension but YouTube still looks unchanged:

1. Open `chrome://extensions`.
2. Click the reload button on **YouTube Swipe** after pulling or copying new files.
3. Refresh the YouTube watch tab.
4. Make sure the URL starts with `https://www.youtube.com/watch?v=` and is not a Shorts, Music, Studio, channel, or search page.
5. If the overlay says the player is loading for more than a few seconds, refresh the watch page once so the content script can reattach YouTube's native player.
